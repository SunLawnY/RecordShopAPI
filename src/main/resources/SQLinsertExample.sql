...
INSERT INTO Album (id, artist, release_year, genre, album_name, stock)
VALUES (1, 'The Beatles', 1969, 'ROCK', 'Abbey Road', 10);

INSERT INTO Album (id, artist, release_year, genre, album_name, stock)
VALUES (2, 'Michael Jackson', 1982, 'POP', 'Thriller', 15);

INSERT INTO Album (id, artist, release_year, genre, album_name, stock)
VALUES (3, 'Pink Floyd', 1973, 'ROCK', 'The Dark Side of the Moon', 20);
